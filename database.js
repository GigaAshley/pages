var extras = [
	"One Save Scum",
	"Don't have to do any objectives other than killing targets",
	"Can not climb up buildings or shimmy/hang from ledges",
	"Can only incapacitate non-targets by punching them",
	"Disable all HUD Elements (Instinct is still allowed)",
	"Disable Instinct mechanic (HUD elements still allowed)",
	"All HUD elements and Instinct mechanic must be disabled",
	"Set off an explosion in a public area",
	"Hide 5 corpses in the same room",
	"Poison 3 people",
	"Kill 4 people using the same disguise/outfit as them",
